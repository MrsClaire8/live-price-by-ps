...
def popup_window2():
    ...
    def sciezka_cennik():
        ...
        #directory_cennik=directory_cennik.replace('/','\\')
        print(directory_cennik)
    ...
    button_zapisz = Button(window2, text="Zapisz", command=zapisz)
    button_zapisz.grid(row=4, column=0)
...
def przelicz_command():
    ...
    try:
        ...
        print("To jest cennik: ", cennik)

        ceny_zakupu_netto=[cennik.get(k) for k in kod]
